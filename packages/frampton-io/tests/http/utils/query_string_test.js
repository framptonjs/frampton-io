...
QUnit.test('should create query string from object', function(assert) {
...
QUnit.test('should handle array values', function(assert) {
...
QUnit.test('should handle nested objects', function(assert) {
...
QUnit.test('should discard empty arrays', function(assert) {
